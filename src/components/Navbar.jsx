        ...
        <ul className='hidden sm:flex gap-5 text-sm text-gray-700'>
            ...
            <div className='flex items-center gap-6'>  
                ...
                <div className='group relative'>
                   <Link to={'/login'}><img className='w-5 cursor-pointer' src={assets.profile_icon} alt="image de profil" /></Link>
                        <div className='group-hover:block hidden absolute dropdown-menu right-0 pt-4'>
                            <div className='flex flex-col gap-2 w-36 py-5 bg-slate-100 text-gray-500 rounded'>
                                ...
                                <p className='cursor-pointer hover:text-black'>Mes commandes</p>
                                <p className='cursor-pointer hover:text-black'>Se déconnecter</p>
                            </div>
